...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PLOT, wxEVT_PLOT_AREA_CLICKED, 920)
    ...
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PLOT, wxEVT_PLOT_AREA_MOTION, 941)
...
public:
    ...
    wxCoord GetX()
        { return m_x; }
    void SetX( wxCoord pos )
        { m_x = pos; }

    wxCoord GetY()
        { return m_y; }
    void SetY( wxCoord pos )
        { m_y = pos; }
...
private:
    ...
    //Matt's change start
public :
    double GetStartXVal() const {return x_start;}
    wxString GetXLabel() const {return x_label;}
    wxString GetYLabel() const {return y_label;}
    void SetStartXVal(const double & x) { x_start = x; }
    void SetXLabel(const wxString & x) { x_label = x.AfterLast('/'); }
    void SetYLabel(const wxString & y) { y_label = y.AfterLast('/'); }
protected :
    wxString x_label;
    wxString y_label;
    double x_start;
...
class WXDLLIMPEXP_PLOT wxPlotArea: public wxPanel
{
public:
    wxPlotArea() {}
...
class WXDLLIMPEXP_PLOT wxPlotXAxisArea: public wxPanel
{
public:
    wxPlotXAxisArea() {}
...
class WXDLLIMPEXP_PLOT wxPlotYAxisArea: public wxPanel
{
public:
    wxPlotYAxisArea() {}
...
class WXDLLIMPEXP_PLOT wxPlotWindow: public wxPanel
{
public:
    wxPlotWindow() {}
    ...
    //Matt's change start
    void SameRange(bool s=true) { m_samerange = s;}
    bool IsSameRange(void) { return m_samerange; }
    //Matt's change end
    ...
    void OnPlotAreaMotion( wxPlotEvent& event );
...
#define EVT_PLOT_AREA_CLICKED(id, fn) { wxEVT_PLOT_AREA_CLICKED, id, wxID_ANY, (wxObjectEventFunction) (wxEventFunction) (wxCommandEventFunction) (wxNotifyEventFunction) (wxPlotEventFunction) & fn, (wxObject *) NULL },
...
#define EVT_PLOT_MOTION(id, fn) { wxEVT_PLOT_AREA_MOTION, id, wxID_ANY, (wxObjectEventFunction) (wxEventFunction) (wxCommandEventFunction) (wxNotifyEventFunction) (wxPlotEventFunction) & fn, (wxObject *) NULL },
...
#define EVT_PLOT_AREA_CLICKED(id, fn) DECLARE_EVENT_TABLE_ENTRY(wxEVT_PLOT_AREA_CLICKED, id, wxID_ANY, (wxObjectEventFunction) (wxEventFunction) (wxCommandEventFunction) (wxNotifyEventFunction)  wxStaticCastEvent( wxPlotEventFunction, & fn ), (wxObject *) NULL ),
...
#define EVT_PLOT_MOTION(id, fn) DECLARE_EVENT_TABLE_ENTRY(wxEVT_PLOT_AREA_MOTION, id, wxID_ANY, (wxObjectEventFunction) (wxEventFunction) (wxCommandEventFunction) (wxNotifyEventFunction)  wxStaticCastEvent( wxPlotEventFunction, & fn ), (wxObject *) NULL ),
