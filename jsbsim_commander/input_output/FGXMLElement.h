...
public:
  ...
  /** Gets a attribute key 
      @param i the index of the data line to return (0 by default).
      @return a string representing the key requested.*/
  string GetAttributeKey(int i=0) {return attribute_key[i];}

  /// Returns the number of attribute keys
  int GetNumAttributeKeys(void) {return attribute_key.size();}
